...
import com.android.NilaAp.Activity.LoginActivity;
...
public class AdminHome extends AppCompatActivity {
    ...
    int counter = 0;
    private RelativeLayout logoutBtn, newProduct, viewProduct, viewCustomersOrders,viewfeedback,reports, newPreProduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newPreProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Intent intent = new Intent(AdminHome.this, NewPreProductActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void initAll() {
        ...
        newPreProduct = findViewById(R.id.new_pre_product_layout);
