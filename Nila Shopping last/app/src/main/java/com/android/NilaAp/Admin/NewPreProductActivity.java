...
public class NewPreProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_pre_product);

        initAll();

        ArrayAdapter<String> categoryAdapter = new ArrayAdapter<String>(NewPreProductActivity.this, android.R.layout.simple_list_item_1, categoriesList);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    ...
                    Toast.makeText(NewPreProductActivity.this, "Select category", Toast.LENGTH_SHORT).show();
    ...
    private void initAll() {
        ...
        smallCheckBox = findViewById(R.id.pre_size_small_checkbox);
        mediumCheckBox = findViewById(R.id.pre_size_medium_checkbox);
        largeCheckBox = findViewById(R.id.pre_size_large_checkbox);
        extraLargeCheckBox = findViewById(R.id.pre_size_extra_large_checkbox);
        ...
        if (filePath != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(NewPreProductActivity.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(NewPreProductActivity.this, "Photo uploaded...", Toast.LENGTH_SHORT).show();
            ...
            if(isEdit){
                ...
                Toast.makeText(NewPreProductActivity.this, "Select an image", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void SaveInfoToDatabase() {
        ...
        myRootRef.child("Pre-Order Products").child(key).setValue(product).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                progressBar.setVisibility(View.GONE);
                if(isEdit){
                    Toast.makeText(NewPreProductActivity.this, "Product updated Successfully", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(NewPreProductActivity.this, "Product added Successfully", Toast.LENGTH_SHORT).show();
                }
                finish();
